...
1. `20260814_initial_schema.sql`
2. `20260815010000_classes_and_reservations.sql`
3. `20260815020000_admin_class_management.sql`
4. `20260815030000_fix_auth_trigger_and_registration.sql`
5. `20260815040000_security_and_rls_hardening.sql`
6. `20260815050000_student_linking_security.sql`
7. `20260815060000_profiles_update_policy_hardening.sql`
